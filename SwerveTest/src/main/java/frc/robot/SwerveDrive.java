...
public class SwerveDrive extends Robot{
    ...
    //  The absolute encoder is very accurate
    double abs_enc_deadband=.005;  
    ...
    double compute_countsDegrees_ABS(double degrees)
    {
        ...
        //  The absolute encoder returns 1.0
        //  for a 360 degree rotation.  For now,
        //  we are using the same variable.  This
        //  will be changed.
        counts_per_degree=1.0/360.0;

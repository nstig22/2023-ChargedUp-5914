...
//
//  1/17/2023:  Unknown if this method will work - maybe the
//  constructors are valid.  Can we use a Mecanum drive with
//  swerve motors??
//
/////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////
...
public class Drive  {
    ...
    /////////////////////////////////////////////////////////////////
    /////////////////////////////////////////////////////////////////
    double driveFwd_(double distance)
    {
        double error=0.0;
        double counts=0.0;
        double position;
    ...
    public void moveFwd(double speed, double heading) {
        ...
        System.out.printf("angle=%.3f",angle);

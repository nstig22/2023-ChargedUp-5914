  ...
  public void autonomousPeriodic() {
    ...
    if(arm.lowerRotation_complete==false)    {
        if(theta_degrees<0.0)  {
            ...
            arm.rotateLowerArm_CCW(-theta_degrees);
        }   
        if(theta_degrees>0.0) {
            arm.rotateLowerArm_CW(theta_degrees);
        }   
    }
    ...
    if(arm.upperRotation_complete==false)  {
      ...
      if((phi_degrees+theta_degrees)<0.0)  {
        arm.rotateUpperArm_CCW(-(phi_degrees+theta_degrees));
      }  else if((phi_degrees+theta_degrees)>0.0)  {
        arm.rotateUpperArm_CW(phi_degrees+theta_degrees);
      }
    }
